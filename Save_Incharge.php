...
<?php
   ...
   if(isset($_POST["fname"]))	
    {
		$id=$_POST["iid"];
		$iid=filter_var($id,FILTER_SANITIZE_SPECIAL_CHARS);
		$fnam=$_POST["fname"];
		...
		$obj=new register;
		$inf=$obj->insert3($iid,$fname,$lname,$pass,$email,$mob);
		if($inf=="1")
		{
			echo "<center><h3><br>CONGRATS...!!!</h3>
			 <div>
				<img src=\"Images/happy.jpg\" width=30% height=30%><br>
				<h4>You are now registered as a <b>Sector Incharges</b> <br><br>
			 </div></center>";
		}
		else
		{
