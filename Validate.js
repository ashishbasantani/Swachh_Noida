  <script>
	...
	function checkpass(pass)
	 ...
	 function checkpass2(pass)
	 {
 		 if(pass.length>20)
		 {
		  document.getElementById("chck3").innerHTML="Password should not be of more than 20 characters";
		 }
		else if(pass.length<5)
		 {
		  document.getElementById("chck3").innerHTML="Password should be of atleast 5 characters";
		 }
		else
		{
		  document.getElementById("chck3").innerHTML="";
  		}
	 }
	 function confirpass() 
	 {
		...
		{
			document.getElementById("chck4").style.color = "red";
			document.getElementById("chck4").innerHTML = "not matching";
			document.getElementById("but").style.display = "none";
		} 
		else 
		{	
			document.getElementById("chck4").innerHTML = "";
			document.getElementById("but").style.display = "";
		}
	}
  </script>	